...
function AdminLoginModal(param) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const apiUrl = ("TURBOPACK compile-time value", "/api") || "/api";
            const response = await fetch("".concat(apiUrl, "/admin/login"), {
                method: "POST",
                headers: {
...
function AdminDashboard(param) {
    ...
    const fetchUsers = async ()=>{
        ...
        try {
            ...
            const apiUrl = ("TURBOPACK compile-time value", "/api") || "/api";
            const response = await fetch("".concat(apiUrl, "/admin/users"), {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
    ...
    const deleteUser = async (id)=>{
        ...
        try {
            const apiUrl = ("TURBOPACK compile-time value", "/api") || '/api';
            const resp = await fetch("".concat(apiUrl, "/admin/users/").concat(id), {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'x-admin-token': adminToken
...
function RegistrationModal(param) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const apiUrl = ("TURBOPACK compile-time value", "/api") || "/api";
            const response = await fetch("".concat(apiUrl, "/register"), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
//# sourceMappingURL=src_5ef5a0b3._.js.map